    ...
    <PageContainer>
      ...
      <HeroSection id="hero">
        ...
        <HeroContent>
          ...
          <HeroSubtitle>
            Crafting brilliance since 1982 with precision cutting and
      ...
      <AboutSection id="about">
        <Container>
          ...
          <SectionDivider />
          <SectionSubtitle>
            Diamond Manufacturing Excellence Since 1982
          </SectionSubtitle>
              ...
              <Space direction="vertical" size="middle">
                <div style={{ display: "flex", alignItems: "center" }}>
                  ...
                  <Text strong style={{ color: "var(--color-text)" }}>
                    Precision cutting for maximum brilliance
                  </Text>
                </div>
                <div style={{ display: "flex", alignItems: "center" }}>
                  <CheckCircleFilled
      ...
      <FeaturesSection id="features">
        <Container>
          ...
          <SectionDivider />
          <SectionSubtitle>
            What Sets Our Diamond Manufacturing Apart
          </SectionSubtitle>
      ...
      <Section id="process" style={{ background: "var(--color-background)" }}>
        <Container>
          ...
          <SectionDivider />
          <SectionSubtitle>
            The Journey from Rough Diamond to Polished Masterpiece
          </SectionSubtitle>
      ...
      >
        ...
        <Container>
          <div style={{ textAlign: "center" }}>
            ...
            >
              Ready to Experience Diamond Manufacturing{" "}
            ...
            >
              Discover our exceptional diamond manufacturing services and
              explore our collection of precision-cut diamonds.
            </Paragraph>
